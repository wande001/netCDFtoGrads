...
var = c("discharge", "groundwater", "soilMoistureUp","soilMoistureLow")
ref = c("PGF")
...
continentNC = open.ncdf("../continent.nc")
continent = get.var.ncdf(continentNC, "continent")
...
A = makeMatrixRows(4,7, labelSize=2)
...
text(0.22, 6.0, "Surface SM temp. aggr.", srt=90)

par(mar=c(2,0.2,1,0))
plot(1,1,type="n", xlim=c(0,1), ylim=c(-0.15,12.2), xaxs="i", yaxs="i", axes=FALSE, ylab="", xlab="", main="")
text(0.75, seq(0.2,11.8, length=7), seq(0,12,2))
text(0.22, 6.0, "Rootzone SM temp. aggr.", srt=90)

par(mar=c(2,0.2,1,0))
plot(1,1,type="n", xlim=c(0,1), ylim=c(-0.15,12.2), xaxs="i", yaxs="i", axes=FALSE, ylab="", xlab="", main="")
text(0.75, seq(0.2,11.8, length=7), seq(0,12,2))
text(0.22, 6.0, "Groundwater temp. aggr.", srt=90)

par(mar=c(2,0.2,1,0))
plot(1,1,type="n", xlim=c(0,1), ylim=c(-0.15,12.2), xaxs="i", yaxs="i", axes=FALSE, ylab="", xlab="", main="")
text(0.75, seq(0.2,11.8, length=7), seq(0,12,2))
text(0.22, 6.0, "Discharge temp. aggr.", srt=90)
